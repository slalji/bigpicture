...
<ul>
    ...
    <li><?php echo $this->Html->link('Pharmlocs', array('controller' => 'admin', 'action' => 'pharmlocs'));?></li>
  <li><?php echo $this->Html->link('Map Locations', array('controller' => 'admin', 'action' => 'locations'));?></li>
