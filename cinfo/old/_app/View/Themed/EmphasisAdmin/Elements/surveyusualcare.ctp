    <div class="bootstrap span4 collapse-group">
...
<div class="btn btn-warning">More ...</div>
...
echo $this->Form->input('section', array('type' => 'hidden', 'value'=>'usualcare'));
