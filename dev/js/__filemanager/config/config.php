...
date_default_timezone_set('Americas/Los Angeles');
...
|filemanager_access_key:"3fbe87c756a54ebcaedfd58a50f915c7" ,
| ...
|
*/
...
$config = array(
	...
	*/
	...
	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'].'/dev',
	...
	*/
	...
	'access_keys' => array(),*/
     ...
     $salt = 'dsflFWR9u2xQa' (a hard coded string);
     $akey = md5($username.$salt);
    'access_keys' => array(3fbe87c756a54ebcaedfd58a50f915c7),
